...
class Window1:
    ...
    def Logging_in(self):
        ...
        if checker1 is not None:
            ...
            if checker2[0] == pass_word:
                ...
                MsgBox.askyesno('Pharmacy Management System',
    ...
    def Exitting(self):
        self.Exitting = MsgBox.askyesno('Pharmacy Management System', 'Do you want to exit?')
        if self.Exitting > 0:
            self.master.destroy()
            return
...
class Window2:
    def __init__(self, master):
        ...
        # ===============Functions==================
        def iExit():
            iExit = MsgBox.askyesno("registration window", "are you sure to exit?")
            if iExit > 0:
                self.master.destroy()
                return
        ...
        def iResetRecord():
            iResetRecord = MsgBox.askokcancel("registration window",
        ...
        def Record_Add():
            ...
            if (
                ...
                MsgBox.showinfo("inert status", "all fields are not filled")
            else:
                ...
                string = "insert into patients(patient_name, patient_id, adhaar_number," \
                         "patient_address, patient_tele, medicine, quantity ) " \
                ...
                connection.commit()
                ChangeLot(medicine)
                MsgBox.showinfo("insert status", "patient inserted successfully")
                cursor.close()
...
class Window3:
    def __init__(self, master):
        ...
        def iExit():
            iExit = MsgBox.askyesno("Hospital Management System",
        ...
        def iPrescription():
            if (comboNameTablets.get() == "" or PatientName.get() == "" or PatientID.get() == "" or PatientDOB.get() == "" or AadharNumber.get() == ""
                    or RoomNumber.get() == "" or PatientAddress.get() == "" or PhoneNumber.get() == "" or Dose.get() == "" or NumberOfTablets.get() == ""
                    or Lot.get() == "" or MfgDate.get() == "" or ExpDate.get() == "" or Doctor.get() == "" or SideEffects.get() == ""
                    or Information.get() == "" or Reference.get() == "" or DirectionsToUse.get() == ""):
                MsgBox.showinfo("inert status", "all fields are not filled")
            else:
        ...
        def iPrescriptionData():
            ...
            if (name_of_tablet == "" or patient_name == "" or patient_id == "" or patient_dob == '' or adhaar == ''
                    or room_no == "" or patient_address == '' or ph_no == '' or Dose.get() == "" or NumberOfTablets.get() == ''
                    or Lot.get() == '' or MfgDate.get() == '' or ExpDate.get() == '' or Doctor.get() == '' or SideEffects.get() == ''
                    or Information.get() == '' or Reference.get() == "" or DirectionsToUse.get() == ''):
                MsgBox.showinfo("inert status", "all fields are not filled")
            else:
